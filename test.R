## Available tables in dataset "regimen":
##
## concept_ancestor
## concept
## concept_class
...
## vocabulary
##
# DatabaseConnector::executeSql(connection,sql = "CREATE TABLE IF NOT EXISTS regimen_results.test (
#     task_id INT)
#  ")
...
connectionDetails <- createConnectionDetails(
  dbms="bigquery",
  connectionString = Sys.getenv('connectionStringBigQuery'),
  user="",
  password='',
...
writeDatabaseSchema <- "regimen_results"
cdmDatabaseSchema <- "regimen"
